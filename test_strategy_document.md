...
| **Contributors** | • Mohamed Wael Abdelmenem<br>• Nader Ahmed Abdelsattar<br>• Ayad Ahmed Zwail |
...
### Integration Testing
Testing the integrations between the API Gateway, Microservices, Frontend, and Backend
...
### System Testing
End-to-end user workflows and simulation scenarios
...
| **Test Execution Reports** | Detailed reports generated after each test execution<br>Reports to include test results, pass/fail status, and any detected issues |
| **Documentation** | Detailed documentation outlining test scenarios, scripts, and configurations<br>User manuals for executing tests using Katalon |
...
- **Automation Coverage:** 29% (target: 60% for regression tests)
