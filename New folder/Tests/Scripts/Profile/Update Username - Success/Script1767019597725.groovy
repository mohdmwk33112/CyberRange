...
WebUI.click(findTestObject('Object Repository/Profile/input_Username_username'))
...
WebUI.doubleClick(findTestObject('Object Repository/Profile/input_Username_username'))
